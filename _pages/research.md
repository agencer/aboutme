...
<details class="research-card">
  ...
  <p>
    <strong>Abstract.</strong> Disasters are often expected to expose government failure and produce electoral punishment. This project asks why severe exposure may instead leave incumbents politically resilient. I argue that disaster exposure creates two competing forces: destruction can reveal failure and increase blame, but it can also make access to recovery resources more valuable, especially when citizens believe the incumbent has greater control over aid, reconstruction, and the state. The key distinction is that destruction is not dependence. Voters may blame the government for disaster losses while still seeing the incumbent as the safer route to recovery. Using district-level election data from Türkiye after the 2023 earthquakes, I study when crises generate accountability, when they strengthen recovery dependence, and why the politics of rebuilding can differ from the politics of blame.
  </p>
...
<details class="research-card">
  <summary>The politics of social assistance in South Africa: How protests and electoral politics shape the Child Support Grant</summary>
...
<details class="research-card">
  <summary>Democratic BRICS as role models in a shifting global order: Inherent dilemmas and the challenges ahead</summary>
